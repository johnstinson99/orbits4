...
planet1 = Body(name='Planet', mass=5.26e5, radius=4, colour='green', universe_model=my_universe_model)
planet2 = Body(name='Planet', mass=5.26e5, radius=4, colour='blue', universe_model=my_universe_model)
my_body_list = [star1, star2, planet1, planet2]
...
def set_initial_x_coordinates():
    ...
    planet1.x_old = planet1.x = star1.get_habitable_distance()  # put the planet a habitable distance away
    planet2.x_old = planet2.x = -planet1.x
    star2.x_old = star2.x = 10 * planet1.x  # put star 2, 10 times the orbit away.


def scenario2_two_equal_mass_stars_circling_in():
    star2.mass = 1.47e30
    my_body_list.remove(planet1)
    # star2.y += 1e10
    star2.x_old = star2.x = 2.5 * planet1.x  # put star 2, 10 times the orbit away.
...
def scenario4_two_unequal_mass_stars_circling_in():
    ...
    my_body_list.remove(planet1)
    # star2.y += 1e10
    star2.x_old = star2.x = 5.0 * planet1.x  # put star 2, 10 times the orbit away.


def scenario5_stars_very_close_together():
    star2.x_old = star2.x = 2 * planet1.x  # put star 2, 10 times the orbit away.


def scenario6_stars_v_v_close_together():
    star2.x_old = star2.x = 1.50024 * planet1.x  # put star 2, 10 times the orbit away.
...
def set_x_velocities():
    ...
    my_barry_centre = my_universe_model.get_barycentre()
    ...
    planet1.vy = star1.vy + ((UniverseModel.G * star1.mass) / planet1.x) ** 0.5
    planet2.vy = star1.vy - planet1.vy
...
# scenario3_stars_close_together()
